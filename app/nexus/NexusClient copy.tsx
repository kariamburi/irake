...
export default function NexusPage() {
    ...
    const EventCard = ({ e }: { e: EventItem }) => {
        ...
        return (
            <Link
                href={`/nexus/events/${e.id}`}
                onClick={() => cacheEvent(e)}
                className="group block"
            >
                <article className="overflow-hidden rounded-[22px] bg-white transition duration-200 hover:-translate-y-0.5 hover:shadow-lg">
                    <div className="relative aspect-[3/4] w-full overflow-hidden rounded-[22px] bg-[#F6F1EA]">
                        {e.coverUrl ? (
                            <Image
                                src={e.coverUrl}
                            ...
                            <div
                                ...
                                style={{
                                    background:
                                        "linear-gradient(135deg, rgba(35,63,57,0.92), rgba(199,146,87,0.78))",
                                }}
                            />
                        )}
                        ...
                        {e.category ? (
                            <span className="absolute left-2.5 top-2.5 rounded-full bg-white/92 px-2.5 py-1 text-[10px] font-extrabold text-[#233F39] shadow-sm">
                                {e.category}
                            </span>
                        ) : null}
                        ...
                        {countdown ? (
                            <span
                                className={cn(
                                    "absolute right-2.5 top-2.5 rounded-full px-2.5 py-1 text-[10px] font-extrabold shadow-sm",
                                    countdownClass
                                )}
                            >
                                {countdown.text}
                        ...
                        <div className="absolute bottom-2.5 left-2.5 right-2.5 flex items-end justify-between gap-2">
                            {e.location ? (
                                <span className="max-w-[65%] truncate rounded-full bg-white/90 px-2.5 py-1 text-[10px] font-bold text-slate-700 shadow-sm">
                                    {e.location}
                                </span>
                            ) : (
                                <span />
                            ...
                            <span className="rounded-full bg-black/65 px-2.5 py-1 text-[10px] font-bold text-white shadow-sm">
                    ...
                    <div className="px-1.5 pb-1 pt-2.5">
                        <h3
                            className="line-clamp-2 text-[14px] font-black leading-[1.25]"
                            style={{ color: EKARI.text }}
                        >
                            {e.title}
                        </h3>
    ...
    const DiscussionCard = ({ d }: { d: DiscussionItem }) => {
        ...
        return (
            <Link
                href={`/nexus/discussions/${d.id}`}
                onClick={() => cacheDiscussion(d)}
                className="group block"
            >
                <article className="overflow-hidden rounded-[22px] bg-white transition duration-200 hover:-translate-y-0.5 hover:shadow-lg">
                    <div
                        className="relative min-h-[210px] rounded-[22px] p-4"
                        style={{
                            background:
                                "linear-gradient(180deg, rgba(255,255,255,1), rgba(248,245,239,1))",
                        }}
                    >
                        <div className="flex items-start justify-between gap-3">
                            <div className="flex min-w-0 items-center gap-2.5">
                                {d.author?.photoURL ? (
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "linear-gradient(135deg, rgba(35,63,57,1), rgba(199,146,87,0.88))",
                                        }}
                                    >
                                        {initials}
                                    </div>
                            ...
                            {d.category ? (
                                <span className="shrink-0 rounded-full bg-[#F6EFE7] px-2.5 py-1 text-[10px] font-extrabold text-[#233F39]">
                                    {d.category}
                                </span>
                            ) : null}
                        </div>
                        ...
                        <div className="mt-4">
                            <h3
                                className="line-clamp-2 text-[15px] font-black leading-[1.28]"
                                style={{ color: EKARI.text }}
                            >
                                {d.title}
                            </h3>
                        ...
                        <div className="mt-4 flex items-center justify-between">
                            ...
                            <span className="rounded-full bg-black/[0.04] px-2.5 py-1 text-[10px] font-bold text-slate-600 opacity-0 transition group-hover:opacity-100">
                                Open
                            </span>
                        </div>
                    </div>
