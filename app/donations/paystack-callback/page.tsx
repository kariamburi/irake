...
export default function PaystackCallbackPage() {
  ...
  const [donation, setDonation] = useState<(DonationDoc & { id: string }) | null>(null);
          ...
          try {
            ...
            if (userSnap.exists()) {
              ...
              const nameFromFields =
                [u.firstName, u.lastName].filter(Boolean).join(" ") || u.handle || u.username;
  ...
  const currency = (donation?.paidCurrency || donation?.currency || "KES").toUpperCase();
          ...
          <div style={{}}>
            ...
            >
              ...
              {donation.deedId && (
                ...
                >
                  <span>Deed ID</span>
                  <span style={{ fontFamily: "monospace" }}>{donation.deedId}</span>
                </div>
              )}
              {donation.paidAt?.toDate && (
                ...
                >
                  <span>Paid at</span>
                  <span>
                    {donation.paidAt.toDate().toLocaleString()}
                  </span>
                </div>
              )}
            </div>
