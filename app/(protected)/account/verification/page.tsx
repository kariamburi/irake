...
export default function VerificationPage() {
  ...
  const Body = (
    <div className={isDesktop ? "w-full px-4 md:px-8 py-8 md:py-10" : "w-full px-4 py-6"}>
      {/* Desktop header (avoid double header on mobile) */}
      {isDesktop && (
        <div className="flex h-12 items-center justify-between border-b border-gray-200 mb-6">
          ...
          <div className="font-extrabold text-slate-900">Account verification</div>
          <div className="w-8" />
        </div>
      )}

      <h1 className="text-2xl md:text-3xl font-black" style={{ color: EKARI.text }}>
        Account verification
      </h1>
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundImage: "linear-gradient(90deg, #233F39, #C79257)",
                }}
              />
            </div>
          </div>
