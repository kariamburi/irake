...
import { IoCubeOutline, IoCheckmarkDone, IoCashOutline, IoTimeOutline, IoEyeOffOutline, IoTrashOutline } from "react-icons/io5";
    ...
    return (
        <div className="p-4 md:p-6 space-y-6">
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filtered.map((l) => {
                        const status: MarketStatus = (l.status ||
                            (l as any).sold
                            ? "sold"
                            : "active") as MarketStatus;
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-3 flex-1 flex flex-col gap-2">
                                    ...
                                    <div className="text-sm font-black" style={{ color: EKARI.forest }}>
                                        {priceText}
                                    </div>
