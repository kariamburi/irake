                ...
                <div className="flex h-full w-full">
                    <div className="relative h-full min-w-0 flex-1 overflow-hidden">
                        <div className="flex h-full w-full items-stretch justify-center">
                            <div className="relative h-full w-full lg:w-[646px] lg:min-w-[646px] lg:max-w-[646px]">
                                <section
                                    ref={scrollerRef}
                                    tabIndex={0}
                                ...
                                {isDesktop ? (
                                    <div className="pointer-events-none absolute inset-y-0 right-0 z-[45] hidden w-[92px] lg:flex">
