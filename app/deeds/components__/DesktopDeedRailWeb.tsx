...
export function DesktopDeedRailWeb({
    ...
    return (
        <div className="hidden h-full w-full flex-col items-center justify-center gap-4 pt-3 lg:flex">
            <button
                type="button"
                onClick={onPrev}
                disabled={!canGoPrev}
                ...
                className={[
                    "grid h-12 w-12 place-items-center rounded-full border border-white/30 bg-white/10 text-white backdrop-blur-md transition",
                    canGoPrev
                        ? "hover:bg-white/20"
